...
let crore = new Audio("./Requires/5crore.mp3");
...
document.querySelectorAll(".levels")[2].addEventListener("click", () => {
    console.log("click")
    difficulty = document.querySelectorAll(".levels")[2].innerHTML;
    console.log(difficulty)
    rules.style.display = "block"
    intro.pause()
})
...
document.querySelectorAll(".levels")[2].addEventListener("mouseenter", () => {
    playaudio("./Requires/tangg.mp3")
})
...
{
    question: 'In which sports player use there hands to knock a ball over net',
...
const snu_question = [{
    question: 'Which of the given place you most likly to visit when you are in mood with your Girlfriend',
    options: [{ A: "A: Library" }, { B: "B: Canopies" }, { C: "C: D Block" }, { D: "D: ISC" }, { Correct: "B: Canopies" }],
    audio: "./Requires/pahla prashan.mp3",
    audio2: './Requires/bilkul sahi jawab.mp3'
},
...
{
    question: 'Which is upcomming next infrastucture building project in the campus',
    options: [{ A: "A: 6th Cluster" }, { B: "B: Shopping Mall" }, { C: "C: Swimming Pool" }, { D: "D: Hockey Ground" }, { Correct: "C: Swimming Pool" }],
    audio: './Requires/dusra prashan.mp3',
    audio2: './Requires/well done.mp3'
},
...
{
    question: 'Who is the Tech team lead of Team A in Breeze',
    options: [{ A: "A: Aryan Passan and Kunal Tomar" }, { B: "B: Aryan Sethia and Siddhant Agnihotri" }, { C: "C: Santosh Singh and Rajiv Kummar" }, { D: "D: Aryan Tomar and Kunal Passan" }, { Correct: "D: Aryan Tomar and Kunal Passan" }],
    audio: './Requires/teesra prashan.mp3',
    audio2: './Requires/bilkul sahi jawab.mp3',
    audio2: './Requires/well done 2.mp3'
},
...
{
    question: 'Which is the least visited place by students in SNU',
    options: [{ A: "A: 19th hall" }, { B: "B: Library" }, { C: "C: Botanical Garden" }, { D: "D: Dining Hall 3" }, { Correct: "C: Botanical Garden" }],
    audio: './Requires/chotha prashan.mp3',
    audio2: './Requires/well done.mp3'
},
...
{
    question: 'Which of the following places is most popular among the students of Snu',

    options: [{ A: "A: Mahesh" }, { B: "B: Arshad" }, { C: "C: DLF Mall" }, { D: "D: Bonnies Pizza" }, { Correct: "A: Mahesh" }],
    audio: './Requires/paachva prashan.mp3',
    audio2: './Requires/bilkul sahi jawab.mp3'
},
...
{
    question: 'What is the name bhaiya who do night shift in Naveen Tea House',
    options: [{ A: "A: Pappu Bhaiya" }, { B: "B: Mappu Bhaiya" }, { C: "C: Gappu Bhaiya" }, { D: "D: Chhapu Bhaiya" }, { Correct: "A: Pappu Bhaiya" }],
    audio: './Requires/chatha prashan.mp3',
    audio2: './Requires/ye sahi jawab hai.mp3'
},
...
{
    question: 'What is the name of club which oraganise Movie screening in B-315 or AC bhi ni chalate.',
    options: [{ A: "A: Surge SNU" }, { B: "B: Cine SNU" }, { C: "C: Cine U" }, { D: "D: Breeze" }, { Correct: "C: Cine U" }],
    audio: './Requires/saatwa prashan.mp3',
    audio2: './Requires/bilkul sahi jawab.mp3'
},
...
{
    question: 'Where will you go if you are feeling hungry at 4:00 AM in Morning',
    options: [{ A: "A: A&B" }, { B: "B: C&D" }, { C: "C: Arcade" }, { D: "D: Mini Mart" }, { Correct: "D: Mini Mart" }],
    audio: './Requires/aadhva prashan.mp3',
    audio2: './Requires/well done 2.mp3'
},
...
{
    question: 'What is the name of watchman who only works in day shift in the Library with Big Moustache and also famous among students on instagram.',
    options: [{ A: "A: Sorabh Janardan Sangwan" }, { B: "B: Anand Bhati" }, { C: "C: Radhe Bhokal" }, { D: "D: Sulpher Dioxide" }, { Correct: "C: Radhe Bhokal" }],
    audio2: './Requires/ye sahi jawab hai.mp3',
    audio: './Requires/nova prashan.mp3',
...
{
    question: 'Which of these event happens in Main Arena generally in month of March',
    options: [{ A: "A: Breeze" }, { B: "B: Inter Departmental Tournaments" }, { C: "C: Surge " }, { D: "D: fashion Show" }, { Correct: "A: Breeze" }],
    audio: './Requires/dasva prashan.mp3',
    audio2: './Requires/5crore.mp3'
}
]
...
function load_question(i) {
    ...
    if (difficulty == document.getElementById("snu").innerHTML) {

        playaudio(snu_question[i].audio)


        document.querySelector('.question').innerHTML = snu_question[i].question;

        document.getElementById("A").innerHTML = snu_question[i].options[0].A;
        document.getElementById("B").innerHTML = snu_question[i].options[1].B;
        document.getElementById("C").innerHTML = snu_question[i].options[2].C;
        document.getElementById("D").innerHTML = snu_question[i].options[3].D;
...
document.getElementById("check").addEventListener("click", () => {
    ...
    if (difficulty == document.getElementById("snu").innerHTML){
        ...
        if (select == snu_question[question_number].options[4].Correct) {


            playaudio(snu_question[question_number].audio2)

            if (select == snu_question[question_number].options[0].A) {
                document.getElementById("A").style.background = "radial-gradient(#3c811c,#3e7920)"
                document.getElementById("A").style.color = "white"

            }

            if (select == snu_question[question_number].options[1].B) {
                document.getElementById("B").style.background = "radial-gradient(#3c811c,#3e7920)"
                document.getElementById("B").style.color = "white"

            }

            if (select == snu_question[question_number].options[2].C) {
                document.getElementById("C").style.background = "radial-gradient(#3c811c,#3e7920)"
                document.getElementById("C").style.color = "white"

            }

            if (select == snu_question[question_number].options[3].D) {
                document.getElementById("D").style.background = "radial-gradient(#3c811c,#3e7920)"
                document.getElementById("D").style.color = "white"
        ...
        } else if (select != snu_question[question_number].options[4].Correct) {
            ...
            if (select == snu_question[question_number].options[0].A) {
                ...
                if (snu_question[question_number].options[4].Correct == snu_question[question_number].options[1].B) {
                    document.getElementById("B").style.background = "radial-gradient(#3c811c,#3e7920)"
                    document.getElementById("B").style.color = "white"
                }

                if (snu_question[question_number].options[4].Correct == snu_question[question_number].options[2].C) {
                    document.getElementById("C").style.background = "radial-gradient(#3c811c,#3e7920)"
                    document.getElementById("C").style.color = "white"
                }

                if (snu_question[question_number].options[4].Correct == snu_question[question_number].options[3].D) {
                    document.getElementById("D").style.background = "radial-gradient(#3c811c,#3e7920)"
                    document.getElementById("D").style.color = "white"
                }
            ...
            if (select == snu_question[question_number].options[1].B) {
                ...
                if (snu_question[question_number].options[4].Correct == snu_question[question_number].options[0].A) {
                    document.getElementById("A").style.background = "radial-gradient(#3c811c,#3e7920)"
                    document.getElementById("A").style.color = "white"
                }
